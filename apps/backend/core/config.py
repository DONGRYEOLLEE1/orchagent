...
class Settings(BaseSettings):
    ...
    ATTACHMENT_MAX_FILES_PER_REQUEST: int = 5
    ATTACHMENT_MAX_TOTAL_BYTES: int = 30 * 1024 * 1024
    ATTACHMENT_MAX_IMAGE_BYTES: int = 10 * 1024 * 1024
    ATTACHMENT_MAX_PDF_BYTES: int = 20 * 1024 * 1024
    ATTACHMENT_MAX_DOCX_BYTES: int = 20 * 1024 * 1024
