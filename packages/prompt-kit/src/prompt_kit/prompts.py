...
3. When you set `next` to `FINISH` and want to provide a direct user-facing answer yourself, write that answer into the message you return. If you delegate to another team, keep your message empty so downstream workers can speak.
4. If you can answer simple greetings or general common sense directly, return `FINISH` with your answer.
